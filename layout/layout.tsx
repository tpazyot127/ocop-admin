...
const Layout = ({ children }: ChildContainerProps) => {
    ...
    const themeContext = useContext(PrimeReactContext);
    ...
    useMountEffect(() => {
        if (themeContext?.setRipple) {
            themeContext.setRipple(layoutConfig.ripple);
        }
    });
    ...
    return (
        <React.Fragment>
            <Head>
                <title>Trang quản trị hợp tác xã OCOP</title>
                <meta charSet="UTF-8" />
                <meta
                    name="description"
